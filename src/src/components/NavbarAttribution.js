...
import styles from "./NavbarAttribution.module.css";

const NavbarAttribution = ({ onClose }) => {
  ...
  return (
    <div className={styles.navbarAttribution} data-animate-on-scroll>
      ...
      <div className={styles.menuItem}>
        ...
        <div className={styles.frameParent}>
          <button className={styles.rocketlaunchParent}>
            ...
            />
            <div className={styles.analytics}>Attribution</div>
          </button>
...
export default NavbarAttribution;
