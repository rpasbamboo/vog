...
import styles from "./NavbarRetargetting.module.css";

const NavbarRetargetting = ({ onClose }) => {
  ...
  return (
    <div className={styles.navbarRetargetting} data-animate-on-scroll>
...
export default NavbarRetargetting;
