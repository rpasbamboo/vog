...
const SettingNavbar = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-[21.4px] right-[0px] rounded-[11.43px] bg-white shadow-[0px_1.4px_7.14px_rgba(0,_0,_0,_0.1)] box-border w-[144.3px] flex flex-col items-start justify-center pt-[25.714399337768555px] px-[11.428622245788574px] pb-[11.428622245788574px] gap-[8.57px] border-[1.4px] border-solid border-whitesmoke-400">
