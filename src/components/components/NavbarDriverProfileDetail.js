...
const NavbarDriverProfileDetail = ({ onClose }) => {
  ...
  return (
    <div
      className="bg-white box-border w-[187.9px] h-full overflow-hidden [&.animate]:animate-[0.25s_ease_0s_1_normal_forwards_slide-in-left] opacity-[0] max-w-[90%] text-left text-[12.86px] text-gray-200 font-lexend border-r-[2.1px] border-solid border-gainsboro-300"
      data-animate-on-scroll
    >
      ...
      >
        ...
        <img
          className="absolute top-[0px] left-[43.6px] rounded-[50%] w-[42.9px] h-[42.9px] object-cover"
          alt=""
...
export default NavbarDriverProfileDetail;
