    ...
    >
      ...
      <div className="absolute top-[112.9px] left-[0px] w-[178.6px] flex flex-col items-start justify-start gap-[5.71px]">
        ...
        <div className="self-stretch flex flex-col items-center justify-center relative gap-[39.29px]">
          <button
            className="cursor-pointer [border:none] py-[11.428622245788574px] px-[22.85724449157715px] bg-lavenderblush rounded-[11.43px] shadow-[0px_2.9px_41.43px_rgba(0,_0,_0,_0.07)] w-[156.4px] flex flex-row items-center justify-start box-border gap-[5.71px] z-[0]"
