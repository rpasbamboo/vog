...
import styles from "./NavbarAboutCampaings.module.css";

const NavbarAboutCampaings = ({ onClose }) => {
  ...
  return (
    <div className={styles.navbarAboutCampaings} data-animate-on-scroll>
      ...
      <div className={styles.menuItem}>
        ...
        <div className={styles.frameParent}>
          <button className={styles.carprofileParent}>
            <img className={styles.growthIcon} alt="" src="/carprofile1.svg" />
      ...
      <div className={styles.logoutParent} onClick={onGroupContainerClick}>
        <div className={styles.logout}>
          ...
          <div className={styles.logoutGroup}>
            ...
            <div className={styles.theresaMilly}>Logout</div>
          </div>
        </div>
...
export default NavbarAboutCampaings;
